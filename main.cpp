...
{ 
    ...
    {
        std::cout << "################ std::map + other_allocator ################" << std::endl;
    ...
    {
        std::cout << "################ other_list + std:allocator ################" << std::endl;
    ...
    {
        std::cout << "################ other_list + other_allocator ##############" << std::endl;
    ...
    {
        std::cout << "################ other_list + copy constructor #############" << std::endl;
    ...
    {
        std::cout << "################ other_list + move #########################" << std::endl;
